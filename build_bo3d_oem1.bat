...
#build
%dev2008% dwindow\dwindow.sln /build "Release_oem1"
...
copy/y dwindow\release_oem1\StereoPlayer.exe dwindow_NSIS
copy/y reset\release\reset.exe dwindow_NSIS
copy/y dwindow\release_oem1\lua.dll dwindow_NSIS
