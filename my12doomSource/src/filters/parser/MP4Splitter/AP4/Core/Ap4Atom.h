...
const AP4_Atom::Type AP4_ATOM_TYPE_3DVF = AP4_ATOM_TYPE('3','d','v','f');
...
const AP4_Atom::Type AP4_ATOM_TYPE_avid = AP4_ATOM_TYPE('a','v','i','d');
...
const AP4_Atom::Type AP4_ATOM_TYPE_MVCC = AP4_ATOM_TYPE('m','v','c','C');
