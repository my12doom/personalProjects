...
DEFINE_GUID(CLSID_LentoidHEVCDecoder, 0x658C5E1C, 0x58E1, 0x43CA, 0x9D, 0x10, 0x13, 0x73, 0x5d, 0x46, 0x55, 0x76);
...
DEFINE_GUID(CLSID_RMSplitter, 0x765035b3, 0x5944, 0x4a94, 0x80, 0x6b, 0x20, 0xee, 0x34, 0x15, 0xf2, 0x6f);
