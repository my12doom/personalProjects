...
EXTERN_C const IID IID_Icrypt;
    ...
    public:
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE genkey3( 
            BSTR passkey,
            LONG time_start,
            BSTR time_end,
            LONG max_bar_user,
        ...
        virtual /* [helpstring][id] */ HRESULT STDMETHODCALLTYPE genkey4( 
            BSTR passkey,
            LONG time_start,
            LONG time_end,
            LONG max_bar_user,
    ...
    typedef struct IcryptVtbl
    {
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *genkey3 )( 
            Icrypt * This,
            BSTR passkey,
            LONG time_start,
            BSTR time_end,
        ...
        /* [helpstring][id] */ HRESULT ( STDMETHODCALLTYPE *genkey4 )( 
            Icrypt * This,
            BSTR passkey,
            LONG time_start,
            LONG time_end,
