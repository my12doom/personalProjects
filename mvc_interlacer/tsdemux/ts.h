...
namespace ts
{
    ...
    public:
		// my12doom's code
		CFileBuffer *demux_target_left;
		CFileBuffer *demux_target_right;
		bool silence;
...
#endif
    public:
        demuxer(void):hdmv(false),av_only(true),parse_only(false),dump(0),channel(0),base_pts(0),pes_output(0),verb(false),es_parse(false),subs(0),subs_num(0),silence(false),demux_target_left(NULL), demux_target_right(NULL) {}
