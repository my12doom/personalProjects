...
static int mov_read_pinf(MOVContext *c, AVIOContext *pb, MOVAtom atom)
{
	return 0;
}
...
static const AVClass class = {"mov,mp4,m4a,3gp,3g2,mj2,3dv", av_default_item_name, options, LIBAVUTIL_VERSION_INT};

AVInputFormat ff_mov_demuxer = {
    .name           = "mov,mp4,m4a,3gp,3g2,mj2,3dv",
