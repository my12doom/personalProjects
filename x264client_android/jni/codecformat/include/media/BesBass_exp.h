...
#ifndef __BESBASS_H__
#define __BESBASS_H__
...
typedef struct {
   ...
   // 1==> Stereo
   int CutoffFreq;
   // Cutoff frequency of loudspeaker frequency response.
}BBAS_InitParam;

typedef struct {
   int IsVB;
   // Use Virtual Bass Algorithm or pure Bass boost filter
   // 0 ==> Bass Boost Filter
   // 1 ==> Virtual Bass Algorithm
}BBAS_RuntimeParam;
void BBAS_SetHandle(BS_Handle *pHandle);
