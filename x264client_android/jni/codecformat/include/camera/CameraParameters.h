...
public:
    ...
    //!++
    void setVideoEncBitrate(int bitrate);
    void getVideoEncBitrate(int & bitrate) const;
    void setVideoEncFormat(int format);
    void getVideoEncFormat(int & format) const;
    //!--
    ...
    static const char KEY_FD_MODE[];
    static const char KEY_EIS_MODE [];
    ...
    //
    static const char KEY_DISP_X[];
    static const char KEY_DISP_Y[];
    static const char KEY_DISP_W[];
    static const char KEY_DISP_H[];
    static const char KEY_DISP_ROTATE[];
    //
    ...
    // Values for KEY_RAW_SAVE_MODE
    static const char RAW_SAVE_MODE_ON[];
    static const char RAW_SAVE_MODE_OFF[];
    // Values for KEY_FOCUS_DRAW
    static const int FOCUS_DRAW_OFF;
    static const int FOCUS_DRAW_ON;
    ...
    // Values for video encode bitrate
    typedef enum {
        CAMERA_VENC_BITRATE_LOW = 1,
        CAMERA_VENC_BITRATE_MEDIUM = 2,
        CAMERA_VENC_BITRATE_HIGH = 3
    } CAMERA_VENC_BITRATE_ENUM;
    static const char VIDEO_ENCODE_BITRATE[];
    static const char VIDEO_ENCODE_FORMAT[];    // 0: h.263, 1: mpeg4
    //
