...
enum {
    ...
    //!++
    CAMERA_MSG_COMPRESSED_END   = 0x200,
    CAMERA_MSG_SMILE            = 0x400,
    CAMERA_MSG_PANORAMA         = 0x800,
    CAMERA_MSG_EIS              = 0x1000,
    CAMERA_MSG_MAV              = 0x2000,    
...
enum {
    ...
    //!++
    CAMERA_CMD_DO_PANORAMA          = 4,
    CAMERA_CMD_CANCEL_PANORAMA      = 5,
    CAMERA_CMD_START_SD_PREVIEW     = 6, 
    CAMERA_CMD_CANCEL_SD_PREVIEW    = 7,
    CAMERA_CMD_GET_BURST_NO         = 8,
    CAMERA_CMD_START_MAV            = 9,
    CAMERA_CMD_STOP_MAV           = 10    
    //!--
};
