...
myclient c;
JNIEXPORT jint NAME(startTest)( JNIEnv * env, jobject obj)
{
	LOGE("connectting to 192.168.1.199 : 8080 .... ");
	if (c.connect("192.168.1.199", 8080) < 0)
	{
		LOGE("failed connectting to server");
		return -1;
	}

	LOGE("connectting to 192.168.1.199 : 8080 .... OK");
