...
#build
%dev2008% dwindow\dwindow.sln /build "Release_oem2"
...
del (final)bo3d%v%.exe
ren dwindow_setup.exe (final)bo3d%v%.exe
cd..
copy/y dwindow\release_oem2\StereoPlayer.pdb pdbs\(final)bo3d%v%.pdb